...
import com.kame.springboot.validator.MinutesCheckValidator;

@Documented
@Retention(RUNTIME)
@Target({TYPE, ANNOTATION_TYPE})
@Constraint(validatedBy = {MinutesCheckValidator.class}) // バリデータクラスを指定する
/**
...
public @interface MinutesCheck {
	...
	// String message() default "終了時間は、開始時間以降の時間にしてください";
	 ...
	 Class<?>[] groups() default {};
	  ...
	  String startMinuteProperty();
      String endMinuteProperty();
      String message();
      // 時間もチェックしないといけないから追加
